page 99913 ChooseMatDel2
{
    ...
    var
        TransferDataIns: Page TransfOrderDataIns;
        TransferOrder: Boolean;
        MaterialOrder: Boolean;
        Writeoff: Boolean;
        WriteoffScanPage: Page WriteoffDataIns;
        MatDataIns: Page MatOrderDataIns;

    trigger OnClosePage()
    begin
        IF TransferOrder THEN
            TransferDataIns.RUNMODAL;
        IF Writeoff THEN
