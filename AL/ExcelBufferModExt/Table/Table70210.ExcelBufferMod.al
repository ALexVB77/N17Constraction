table 70210 "Excel Buffer Mod"
{
    ...
    var
        ...
        TempInfoExcelBuf: Record "Excel Buffer Mod" temporary;
    ...
    procedure WriteAllToCurrentSheet(var ExcelBuffer: Record "Excel Buffer Mod")
    var
    ...
    procedure WriteCellValue(ExcelBuffer: Record "Excel Buffer Mod")
    var
    ...
    procedure WriteCellFormula(ExcelBuffer: Record "Excel Buffer Mod")
    var
        Decorator: DotNet CellDecorator;
    begin
        with ExcelBuffer do begin
    ...
    var
        TempExcelBuf: Record "Excel Buffer Mod" temporary;
        ToxlRowID: Text[10];
    begin
    ...
    procedure ExportBudgetFilterToFormula(var ExcelBuf: Record "Excel Buffer Mod"): Boolean
    var
        TempExcelBufFormula: Record "Excel Buffer Mod" temporary;
        TempExcelBufFormula2: Record "Excel Buffer Mod" temporary;
        FirstRow: Integer;
        LastRow: Integer;
    ...
    local procedure AddColumnToBuffer(var ExcelBuffer: Record "Excel Buffer Mod"; Value: Variant; IsFormula: Boolean; CommentText: Text; IsBold: Boolean; IsItalics: Boolean; IsUnderline: Boolean; NumFormat: Text[30]; CellType: Option)
    begin
    ...
    procedure EnterCell(var ExcelBuffer: Record "Excel Buffer Mod"; RowNo: Integer; ColumnNo: Integer; Value: Variant; IsBold: Boolean; IsItalics: Boolean; IsUnderline: Boolean)
    begin
        ExcelBuffer.Init();
    ...
    var
        DummyExcelBuf: Record "Excel Buffer Mod";
    begin
    ...
    local procedure OnAfterAddColumnToBuffer(var ExcelBuffer: Record "Excel Buffer Mod"; Value: Variant; IsFormula: Boolean; CommentText: Text; IsBold: Boolean; IsItalics: Boolean; IsUnderline: Boolean; NumFormat: Text[30]; CellType: Option)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeParseCellValue(var ExcelBuffer: Record "Excel Buffer Mod"; var Value: Text; var FormatString: Text; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnWriteCellValueOnBeforeSetCellValue(var ExcelBuffer: Record "Excel Buffer Mod"; var CellTextValue: Text)
    begin
    end;
}
