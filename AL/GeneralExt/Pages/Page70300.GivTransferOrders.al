page 70300 "Giv. Transfer Orders"
{
    // NC 51410
    //  создал объект на основе стандартного page "Transfer Orders"
    //  для отображения списка заказов на передачу материалов в переработку ("Giv. Transfer Order")

    ApplicationArea = Location;
    Caption = 'Giv. Transfer Orders';
    CardPageID = "Giv. Transfer Order";
    Editable = false;
    PageType = List;
