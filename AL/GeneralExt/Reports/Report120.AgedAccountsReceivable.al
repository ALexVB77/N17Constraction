report 80120 "Aged Accounts Receivable Ext"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Header; "Integer")
        {
            ...
            column(CustPostGroupCptnLbl; CustPostGroupCptnLbl)
            {
            }
            column(CostPlaceCptnLbl; CostPlaceCptnLbl)
            {
            }
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(TempCustLedgEntryLoop; "Integer")
                    {
                        ...
                        column(CP_Code; TempCustLedgEntry."Global Dimension 1 Code")
                        {
                        }
                        ...
                        begin
                            ...
                            if CPFilter <> '' then
                                TempCustLedgEntry.SetFilter("Global Dimension 1 Code", CPFilter);
