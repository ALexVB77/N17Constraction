// NC AB: Основа - report 1320 "Notification Email"

report 50121 "Notification Email Act. Inv."
{
    WordLayout = './Reports/Layouts/NotificationEmailActInv.docx';
    Caption = 'Notification Email Act. Inv.';
    DefaultLayout = Word;
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            */
            dataitem("Notification Entry"; "Notification Entry")
            {
                ...
                */
                column(ActionTextRUS; ActionTextRUS)
                {
                }
                column(ActionTextENU; ActionTextENU)
                {
                }
                /*
    ...
    */
    ...
    var
        CurrLng: Integer;
    begin
        CurrLng := GlobalLanguage();
        GlobalLanguage(1033);
        ActionTextENU := NotificationManagement.GetActionTextFor("Notification Entry");
        GlobalLanguage(1049);
        ActionTextRUS := NotificationManagement.GetActionTextFor("Notification Entry");
        GlobalLanguage(CurrLng);
    end;
