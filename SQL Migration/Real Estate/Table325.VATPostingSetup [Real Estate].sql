...
LEFT JOIN [Bonava-Test].[dbo].[Real Estate$G_L Account Mapping$2944687f-9cf8-4134-a24c-e21fb70a8b1a] GLAccMapping2
ON GLAccMapping2.[Old No_] = [Sales VAT Unreal_ Account] collate Cyrillic_General_100_CI_AS
LEFT JOIN [Bonava-Test].[dbo].[Real Estate$G_L Account Mapping$2944687f-9cf8-4134-a24c-e21fb70a8b1a] GLAccMapping3
ON GLAccMapping3.[Old No_] = [Purchase VAT Account] collate Cyrillic_General_100_CI_AS
LEFT JOIN [Bonava-Test].[dbo].[Real Estate$G_L Account Mapping$2944687f-9cf8-4134-a24c-e21fb70a8b1a] GLAccMapping4
ON GLAccMapping4.[Old No_] = [Purch_ VAT Unreal_ Account] collate Cyrillic_General_100_CI_AS
LEFT JOIN [Bonava-Test].[dbo].[Real Estate$G_L Account Mapping$2944687f-9cf8-4134-a24c-e21fb70a8b1a] GLAccMapping5
...
DELETE FROM [Bonava-Test].[dbo].[Real Estate$VAT Posting Setup$2944687f-9cf8-4134-a24c-e21fb70a8b1a];

--Table Extension
INSERT INTO [Bonava-Test].[dbo].[Real Estate$VAT Posting Setup$2944687f-9cf8-4134-a24c-e21fb70a8b1a]
(
	[VAT Bus_ Posting Group],
	[VAT Prod_ Posting Group],
	[VAT Allocation]
