...
( SELECT DISTINCT
  ...
  FROM [Bonava-Test].[dbo].[Real Estate$Dimension Mapping$2944687f-9cf8-4134-a24c-e21fb70a8b1a] AS DimensionMapping 
...
( SELECT DISTINCT
  ...
  FROM [Bonava-Test].[dbo].[Real Estate$Dimension Mapping$2944687f-9cf8-4134-a24c-e21fb70a8b1a] AS DimensionMapping 
  WHERE DimensionMapping.[Dimension Code] = 'CP') QueryResult
LEFT JOIN [VM-PRO-SQL007\NAV].[NAV_for_Developers].[dbo].[NCC Real Estate$Building turn] BuildingTurn
