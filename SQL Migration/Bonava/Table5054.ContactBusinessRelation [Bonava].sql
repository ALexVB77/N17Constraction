...
SELECT 
	...
	CBR.[Link to Table],
	CBR.[No_]
FROM [VM-PRO-SQL007\NAV].[NAV_for_Developers].[dbo].[Bonava$Contact Business Relation] AS CBR
INNER JOIN [Bonava-Test].[dbo].[Bonava$Customer$437dbf0e-84ff-417a-965d-ed2bb9650972] Customer
